"""
Real-time Gesture Classification using trained Random Forest model.
...
# Model path
MODEL_PATH = "random_forest_classifier/model.pkl"
    ...
    def __init__(self, model_path: str = MODEL_PATH):
        if not os.path.exists(model_path):
            raise FileNotFoundError(
                ...
                f"Run 'python random_forest_classifier/train.py' first."
            )
