...
from classifiers.ffnn.train import GestureNet, extract_features
...
class FFNNClassifier:
    ...
    def __init__(self, model_path: Path = None, threshold: float = 0.7):
    ...
    def load_model(self, model_path: Path):
        ...
        if not model_path.exists():
            raise FileNotFoundError(
                ...
                "Please train the model first: python classifiers/ffnn/train.py"
            )
