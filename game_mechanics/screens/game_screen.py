...
from config import Scoreboard, GameScore, ScoreConfig
...
class GameScreenManager:
    ...
    def __init__(self, frame_width: int = None, frame_height: int = None):
        # Import here to avoid circular import, use config defaults
        from config import FRAME_WIDTH as DEFAULT_WIDTH, FRAME_HEIGHT as DEFAULT_HEIGHT
        self.frame_width = frame_width if frame_width is not None else DEFAULT_WIDTH
        self.frame_height = frame_height if frame_height is not None else DEFAULT_HEIGHT
